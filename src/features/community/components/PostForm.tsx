            ...
            {category === "RECRUITMENT" && (
                <div className="flex flex-col gap-5 p-4 border rounded-lg bg-blue-50/20 dark:bg-blue-900/10 border-blue-100 dark:border-blue-900/30">
                            ...
                            >
                                <PopoverTrigger asChild>
                                    <Button
                                        ...
                                        role="combobox"
                                        aria-expanded={open}
                                        className="w-full justify-between h-10 border-blue-200 dark:border-blue-900/50 bg-white dark:bg-neutral-900/50"
                                    >
                                        기술 스택 선택
                                            ...
                                            <CommandGroup>
                                                {TECH_STACKS.map(
                                                    (stack) => (
                                                        ...
                                                        >
                                                            <Check
                                                                className={`mr-2 h-4 w-4 ${tags.includes(
                                                                    stack
                                                                )
                                                                    ? "opacity-100"
                                                                    : "opacity-0"
                    ...
                    <div className="space-y-2.5">
                        ...
                        <p className="text-[10px] text-blue-500/80 dark:text-blue-400/60 ml-0.5 italic">
                            * 2인 이상 10인 이하만 가능합니다.
                        </p>
                    </div>
                </div>
                ...
                <div className="flex justify-between items-center px-1">
                    ...
                    >
                        <TabsList className="h-8 bg-muted/50 dark:bg-neutral-800/50">
                            <TabsTrigger
                                value="write"
                                className="text-[10px] md:text-xs px-3"
                            >
                                Write
                            </TabsTrigger>
